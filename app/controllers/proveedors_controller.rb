class ProveedorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @proveedor.save
        format.html { redirect_to @proveedor, notice: 'Proveedor agregado correctamente.' }
  ...
  def destroy
    @proveedor.destroy
    respond_to do |format|
      format.html { redirect_to proveedors_url, notice: 'Proveedor eliminado correctamente.' }
  ...
  private
    ...
    def proveedor_params
      params.require(:proveedor).permit(:empresa, :correo)
    end
end
