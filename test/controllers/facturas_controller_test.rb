...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { cantidad: @factura.cantidad, pintura_id: @factura.pintura_id, precio: @factura.precio, proveedor_id: @factura.proveedor_id }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { cantidad: @factura.cantidad, pintura_id: @factura.pintura_id, precio: @factura.precio, proveedor_id: @factura.proveedor_id }
    assert_redirected_to factura_path(assigns(:factura))
  end
